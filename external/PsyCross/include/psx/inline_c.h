...
#define PSYX_PGXP_MATRIX_ROT(matrix) PGXP_MatrixSetRot((const void*)(matrix))
#define PSYX_PGXP_MATRIX_TRANS(matrix) PGXP_MatrixSetTrans((const void*)(matrix))
#define PSYX_PGXP_VECTOR_LOAD(vector, slot) PGXP_VectorLoad((const void*)(vector), (slot))
#else
#define PSYX_PGXP_MATRIX_ROT(matrix) ((void)0)
#define PSYX_PGXP_MATRIX_TRANS(matrix) ((void)0)
#define PSYX_PGXP_VECTOR_LOAD(vector, slot) ((void)0)
#endif
...
#define gte_ldv3( r0, r1, r2 ) \
	{	MTC2(*(uint*)((char*)(r0)+0), 0);\
		...
		PSYX_PGXP_VECTOR_LOAD((r0), 0);\
		PSYX_PGXP_VECTOR_LOAD((r1), 1);\
		PSYX_PGXP_VECTOR_LOAD((r2), 2);}
