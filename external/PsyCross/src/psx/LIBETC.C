...
VSyncCallbackProc vsync_callback = NULL;
...
VSyncCallbackProc ResetCallback(void)
{
	VSyncCallbackProc old = vsync_callback;
	vsync_callback = NULL;
	return old;
}
...
VSyncCallbackProc VSyncCallback(VSyncCallbackProc f)
{
	VSyncCallbackProc old = vsync_callback;
	vsync_callback = f;
	return old;
