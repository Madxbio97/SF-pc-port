...
```text
dist/SyphonFilterPC-0.1.0-public-test.12-win64/
dist/SyphonFilterPC-0.1.0-public-test.12-win64.zip
dist/SyphonFilterPC-0.1.0-public-test.12-win64.zip.sha256
```
