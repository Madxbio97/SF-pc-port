param(
    [string]$Version = "0.1.0-public-test.9",
...
- Разделены перемещение WASD и управление прицелом мышью/правым стиком в
  режиме от первого лица; устранены скачки от старого PAD и автозахвата.
- Сглажены first-person перемещение, камера и переключение оружия на частотах
  презентации до 240 FPS при сохранении оригинальной логики 20 Гц.
- Стабилизированы динамические тени персонажей на полу, уступах и стенах,
  уменьшено мерцание при нескольких источниках света.
- Исправлены тест глубины и порядок непрозрачных/полупрозрачных поверхностей
  для стекла и других прозрачных элементов сцены.
- Возвращены единая анимация появления, переносы и безопасные границы подложки
  для геймплейных сообщений в обеих локалях.
- Оригинальные английские подписи снайперских прицелов защищены от случайной
  кириллической перекодировки незавершённых typewriter-пакетов.
- Surface Picker и его диагностический код исключены из публичной сборки.
- Добавлены регрессионные тесты ввода, прицела, сообщений, прозрачной глубины,
  динамического освещения и стабильности теней.
